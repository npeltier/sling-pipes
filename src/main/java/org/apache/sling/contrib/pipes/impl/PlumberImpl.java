...
public class PlumberImpl implements Plumber {
    ...
    Map<String, Class<? extends AbstractPipe>> registry;

    @Activate
    public void activate(){
        registry = new HashMap<String, Class<? extends AbstractPipe>>();
    ...
    @Override
    public void registerPipe(String type, Class<? extends AbstractPipe> pipeClass) {
